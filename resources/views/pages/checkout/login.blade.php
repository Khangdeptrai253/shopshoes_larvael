...
@section('content')
    <div class="row">
        <div class="col-lg-8">
            <form method="post" class="colorlib-form" action="{{route('login-customer')}}">
                {{ csrf_field() }}
                <h2>Đăng Nhập</h2>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" id="fname" class="form-control" placeholder="Your Username"
                                name="username">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group text-center">
                            <div class="radio">
                                ...
                                <div class="d-flex text-center">
                                    <p style= "margin-left:275px;">Bạn chưa có tài khoản ?</p>
                                    <a href="{{route('register')}}" class="text-primary">Đăng Kí Ngay </a>
                                </div>
